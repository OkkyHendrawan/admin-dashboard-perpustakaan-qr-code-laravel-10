...
<head>
    <meta charset="utf-8">
    <title>{{ !empty($header_tittle) ? $header_tittle : '' }} Forgot Password- Stanford Library</title>
            ...
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-slate-500 dark:text-zink-200">Forgot Password</p>
                    </div>
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" class="form-input dark:bg-zink-600/50 border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" required name="email" placeholder="Enter email">
                            <div id="email" class="hidden mt-1 text-sm text-red-500">Please enter a valid email address.</div>
                        </div>
                        <div class="mt-10">
                            <button type="submit" class="w-full text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Forgot Password</button>
                        </div>
                        <div class="mt-10 text-center">
                            <p class="mb-0 text-slate-500 dark:text-zink-200"><a href="{{ url(' ') }}" class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500">Back to Login</a> </p>
                        </div>
                    </form>
                </div>
            </div>
