...
<head>
    ...
    <meta charset="utf-8">
    <title>{{ !empty($header_tittle) ? $header_tittle : '' }} Reset Password - Stanford Library</title>
            ...
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-slate-500 dark:text-zink-200">Reset Password</p>
                    </div>
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="password" class="hidden mt-1 text-sm text-red-500">Password must be at least 8 characters long and contain both letters and numbers.</div>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="inline-block mb-2 text-base font-medium">Password</label>
                            <input type="password" id="password" class="form-input dark:bg-zink-600/50 border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" name="cpassword" placeholder="Confirm password">
                            <div id="password" class="hidden mt-1 text-sm text-red-500">Password must be at least 8 characters long and contain both letters and numbers.</div>
                        </div>
                        <div class="mt-10">
                        ...
                        <div class="mt-10 text-center">
                            <p class="mb-0 text-slate-500 dark:text-zink-200">Do u want forgot password ? <a href="{{ url('forgot-password') }}" class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"> Forgot Password</a> </p>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="!px-10 !pt-10 h-full !pb-0 card-body flex flex-col">
                    <div class="flex items-center justify-between gap-3">
                        <div class="flex justify-center grow">
                            <a href="{{ url(' ') }}">
                                <img src="{{ asset ('/') }}assets/images/perpustakaan.png" alt="" class="hidden h-17 dark:block">
                                <img src="{{ asset ('/') }}assets/images/perpustakaan.png" alt="" class="block h-17 dark:hidden">
                            </a>
                        </div>
                    </div>
                    <div class="mt-auto">
